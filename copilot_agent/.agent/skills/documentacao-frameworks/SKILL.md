---
name: Documentação dos Frameworks
description: Referência rápida dos frameworks Robot Framework, SikuliLibrary, ImageHorizonLibrary e DatabaseLibrary usados no projeto
---

# Skill: Documentação dos Frameworks

## Objetivo

Fornecer referência rápida e precisa sobre os frameworks utilizados no projeto, com foco nas APIs usadas na automação Desktop do myCommerce.

## Quando Usar

- Quando o usuário perguntar sobre **sintaxe** ou **API** de qualquer framework
- Quando for necessário saber **como usar** uma keyword específica de biblioteca
- Para **consultar** funcionalidades disponíveis
...
SikuliLibrary é uma bridge entre Robot Framework e SikuliX para reconhecimento visual de imagens na tela.
...
- SikuliLibrary usa **imagens .png** para encontrar elementos na tela
...
Quando há conflito com keywords de mesmo nome (ex: `Click` existe em SikuliLibrary e ImageHorizonLibrary), usar prefixo:
