...
Teste 20 - Venda com produto normal, sem desconto - 30-60-90-120-180 Dias 
    [Tags]    Teste20
    Dado que acesso a tela de vendas de balcao
    Quando pressiono o atalho de adicionar
    E adiciono vendedor e cliente
...
Teste 21 - Venda com produto com desconto - 30-60-90-120-180 Dias 
    [Tags]    Teste21
    Dado que acesso a tela de vendas de balcao
    Quando pressiono o atalho de adicionar
    E adiciono vendedor e cliente
...
Teste 22 - Venda com mais de um produto, inserindo o desconto no final - 30-60-90-120-180 Dias 
    [Tags]    Teste22
    Dado que acesso a tela de vendas de balcao
    Quando pressiono o atalho de adicionar
    E adiciono vendedor e cliente
...
Teste 23 - Venda com produto com desconto - ultrapassando o limite - 30-60-90-120-180 Dias 
    [Tags]    Teste23
    Dado que acesso a tela de vendas de balcao
    Quando pressiono o atalho de adicionar
    E adiciono vendedor e cliente
...
Teste 24 - Venda com produto com desconto - Dentro do limite - 30-60-90-120-180 Dias 
    [Tags]    Teste24
    Dado que acesso a tela de vendas de balcao
    Quando pressiono o atalho de adicionar
    E adiciono vendedor e cliente
...
Teste 25 - Venda com Desconto ao finalizar - Ultrapassando limite - 30-60-90-120-180 Dias 
    [Tags]    Teste25
    Dado que acesso a tela de vendas de balcao
    Quando pressiono o atalho de adicionar
    E adiciono vendedor e cliente
...
Teste 26 - Venda com mais de um produto, inserindo o desconto no final - Personalizada
    [Tags]    Teste26
    Dado que acesso a tela de vendas de balcao
    Quando pressiono o atalho de adicionar
    E adiciono vendedor e cliente
