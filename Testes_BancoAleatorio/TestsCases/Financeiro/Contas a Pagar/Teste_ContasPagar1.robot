...
Suite Setup    Run Keywords     Start Sikuli Process    AND    keyContasPagar1.Ler imagens iniciais    AND    Conectar ao Banco de Dados    AND    Preparar Ambiente MyCommerce
